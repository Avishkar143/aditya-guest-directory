...
export const hotel = {
  id: 'four-points-nashik',
  name: 'Four Points by Sheraton Nashik',
  city: 'Nashik',
  country: 'India',

  phone: '+91 92250 99414',
  whatsapp: '+91 92250 99414',

  welcomeTitle: 'Welcome to Four Points by Sheraton Nashik',
...
// =========================================================
// GENERIC HOTEL ASSISTANCE
// =========================================================
//
// This system is common for every hotel guest.
// No individual assistant name is stored or displayed.
//
// =========================================================
...
// =========================================================
//
// All restaurants below belong to ONE hotel.
//
...
export const restaurants = [
...

  {
    ...
    description:
      'Breakfast, all-day dining and in-room favourites.',
    image: '',
    ...
    categories: [
      ...
      category(
        'bakery',
        "From the Baker's Oven — Three Pieces",
        [
...

  {
    ...
    description:
      'Food, drinks, coffee, tea and more.',
    image: '',
...
// =========================================================
//
// These will later be managed from the Admin Panel.
//
// Set is_active: false to hide a notice.
//
// =========================================================
...
// =========================================================
//
// These are common for every guest.
// They will later be fully editable from the Admin Panel.
//
// =========================================================
...
export const cityPlaces = [
  /*
  {
    ...
    description:
      'A popular vineyard destination near Nashik known for wine tasting, scenic views and dining.',
...

  {
    ...
    description:
      'One of the twelve Jyotirlinga temples and an important spiritual destination near Nashik.',
...
// =========================================================
//
// Some guest-facing components may use placesToVisit.
// Keep this alias so both names work.
//
// =========================================================

export const placesToVisit = cityPlaces;
...
// =========================================================
//
// This represents the structure that the Admin Panel manages.
//
// Important:
// This is ONE HOTEL.
//
// There is NO hotel-management layer for multiple hotels.
//
// Restaurants / outlets belong to this hotel.
//
// =========================================================
...
// =========================================================
// DEFAULT ADMIN DATA HELPERS
// =========================================================
//
// These helpers make it easier for the Admin Panel to create
// new records while keeping the same structure.
//
// =========================================================
...
// =========================================================
//
// These helpers are used by the guest application and Admin
// Panel to consistently respect active / available status.
//
// =========================================================
...
export const getActiveCategories = (restaurant) =>
  (restaurant?.categories || [])
    .filter((categoryItem) => categoryItem.is_active !== false)
    .sort((a, b) => a.display_order - b.display_order);


export const getAvailableItems = (categoryItem) =>
  (categoryItem?.items || [])
