    ...
    <div className="admin-manager">
      ...
      <div className="admin-manager-toolbar">
        ...
        <div>
          ...
          <p>
            Manage menu categories and individual menu items
            for the hotel.
          </p>
        </div>
      ...
      <div className="admin-coming-soon">
        ...
        <p>
          The menu manager will allow you to manage categories,
          dishes, prices, descriptions, food type and availability
